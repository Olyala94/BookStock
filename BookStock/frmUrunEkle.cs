...
namespace BookStock
{
    public partial class frmUrunEkle : Form
    {
        ...
        private void btnYeniEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("insert into Urun(barkodno,urunadi,miktari,alisfiyati,satisfiyati,tarih) values (@barkodno,@urunadi,@miktari,@alisfiyati,@satisfiyati,@tarih)", connection);
